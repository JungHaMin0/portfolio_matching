...
public class PortRegVO {
	...
	private String portfolio_category_main;
	private String portfolio_category_sub;
	...
	public String getPortfolio_category_main() {
		return portfolio_category_main;
	}
	public void setPortfolio_category_main(String portfolio_category_main) {
		this.portfolio_category_main = portfolio_category_main;
	}
	public String getPortfolio_category_sub() {
		return portfolio_category_sub;
	}
	public void setPortfolio_category_sub(String portfolio_category_sub) {
