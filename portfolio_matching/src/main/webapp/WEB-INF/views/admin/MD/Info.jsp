...
var tabMenu = $("#nav nav-tabs ul>li>a")
 tabMenu.eq(0).click();
</script>
                ...
                <div class="col-lg-offset-3 col-lg-6">
                    <div class="tab" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist"> 	
                            ...
                            <li role="presentation" onclick="location.href='A_Port.do?purUser=${user.user_id}'"><a href="#Section8" aria-controls="profile" role="tab" data-toggle="tab">포폴</a></li>
                        </ul>
