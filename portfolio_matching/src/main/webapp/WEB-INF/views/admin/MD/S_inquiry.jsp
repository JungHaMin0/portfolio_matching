...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <h6 class="m-0 font-weight-bold text-primary">판매문의</h6>
                        </div>
   <div class="container">
                ...
                <div class="col-lg-offset-3 col-lg-6">
                    <div class="tab" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="active" onclick="location.href='A_Sinquiry.do?purUser=${user.user_id}'"><a href="#Section7" aria-controls="profile" role="tab" data-toggle="tab">판매문의</a></li>
  ...
  <div class="tab-slider--container">
         ...
         <div role="tabpanel" class="tab-pane active" id="Section7">
