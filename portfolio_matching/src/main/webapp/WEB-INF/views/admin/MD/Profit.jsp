                ...
                <div class="col-lg-offset-3 col-lg-6">
                    <div class="tab" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="active" onclick="location.href='A_Profit.do?purUser=${user.user_id}'"><a href="#Section6" aria-controls="profile" role="tab" data-toggle="tab">수익현황</a></li>
