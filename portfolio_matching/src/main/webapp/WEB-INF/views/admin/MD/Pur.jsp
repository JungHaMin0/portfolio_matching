                    ...
                    <div class="tab" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist"> 
                            <li role="presentation" onclick="location.href='A_Info.do?purUser=${user.user_id}'"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab" class="on">고객정보</a></li>
                       		<li role="presentation" class="active"  onclick="location.href='A_Pur.do?purUser=${user.user_id}'"><a href="#Section2" aria-controls="profile" role="tab" data-toggle="tab">구매내역</a></li>
                            ...
                            <li role="presentation" onclick="location.href='A_Sale.do?purUser=${user.user_id}'"><a href="#Section5" aria-controls="profile" role="tab" data-toggle="tab">판매내역</a></li>
  ...
  <div class="tab-slider--container">
         <div class="card-body">
            <div class="tab-content tabs">
                    	...
                    	<td class="text-center"><c:out value="${pmPurList.deal_id}"/></td>
                    	 <td class="text-center"> <a href="adminPortfolioDetail.do?portfolio_id=${pmPurList.portfolio_id}">
                         <c:out value="${pmPurList.portfolio_title}"/></a></td>
                       <td class="text-center"><a href="A_Info.do?purUser=${pmPurList.deal_purUser}">
                        <c:out value="${pmPurList.deal_purUser}"/></a></td>
                         <td><a href="A_Info.do?purUser=${pmPurList.deal_saleUser}">
                        <c:out value="${pmPurList.deal_saleUser}"/></a></td> 
                        <td class="text-center"><c:out value="${pmPurList.portfolio_price}"/>원</td>
                        <td class="text-center"><c:out value="${pmPurList.deal_status}"/></td>
                        <td class="text-center"><fmt:formatDate value= "${pmPurList.deal_date}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                    </tr>
                </c:forEach>
