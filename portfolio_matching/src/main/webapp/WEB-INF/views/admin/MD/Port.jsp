...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <h6 class="m-0 font-weight-bold text-primary">포트폴리오</h6>
                        </div>
   <div class="container">
                    ...
                    <div class="tab" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist"> 
                            ...
                            <li role="presentation" onclick="location.href='A_Sinquiry.do?purUser=${user.user_id}'"><a href="#Section7" aria-controls="profile" role="tab" data-toggle="tab">판매문의</a></li>
     					    <li role="presentation" class="active" onclick="location.href='A_Port.do?purUser=${user.user_id}'"><a href="#Section8" aria-controls="profile" role="tab" data-toggle="tab">포폴</a></li>                        </ul>
  <div class="tab-slider--container">
         <div class="card-body">
            <div class="tab-content tabs">
                 
                            <div role="tabpanel" class="tab-pane active" id="Section8">
