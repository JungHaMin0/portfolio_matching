            ...
            <table class="table table-responsive product-dashboard-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="product-details">
                    <h3 class="title">웹페이지 반응형 웹</h3><span class="add-id"><strong>소개</strong>반응형 웹 제작</span><span><strong>등록일</strong>2021-4-25</span><span><strong>판매자</strong>TOSS</span><span><strong>가격</strong>490,000 원</span>
                  </td>
                  <td class="product-category"><span class="categories">웹사이트 개발</span></td>
                  <td class="action" data-title="Action">
                    <div class="">
