			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="product-grid-list">
						<div class="row mt-30">
							<c:forEach items="${webcg}" var="webcg">
							...
							<!-- 이전 -->
								<li class="page-item">
								 <c:choose>
									...
									<a class="page-link" href="webCategory.do${pageMaker.makeSearch(pageMaker.startPage-1)}" aria-label="Previous">
								 ...
								 <c:forEach var="idx" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                   					<li class="page-item"> <a class="page-link"href="webCategory.do${pageMaker.makeSearch(idx)}"> ${idx} </a> </li>
								...
								<li class="page-item">
								 <c:choose>
                        				...
                        				<a class="page-link" href="webCategory.do${pageMaker.makeSearch(pageMaker.endPage+1)}" aria-label="Next">
