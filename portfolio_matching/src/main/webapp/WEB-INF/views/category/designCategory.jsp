									...
									<div class="card">
										<div class="thumb-content">
											...
											<a href="portfolio_detail.do">
												<img class="card-img-top img-fluid" src="${designcg.portlist_url}">
											</a>
										</div>
										<div class="card-body">
											<h4 class="card-title"><a href="single.html"><c:out value="${designcg.portlist_title}"/></a></h4>
											<ul class="list-inline product-meta">
												<li class="list-inline-item">
													<a href="single.html"><i class="fa fa-folder-open-o"></i><c:out value="${designcg.portlist_category}"/></a>
												</li>
												<li class="list-inline-item">
													<a href="#"><i class="fa fa-calendar"></i><c:out value="${designcg.portlist_day}"/></a>
												</li>
											</ul>
											<p class="card-text"><c:out value="${designcg.portlist_content}"/></p>
											<div class="product-ratings">
												<ul class="list-inline">
													<li class="list-inline-item selected"><i class="fa fa-star"></i><c:out value="${designcg.portlist_rating}" /></li>
												</ul>
											</div>
										</div>
									</div>
