							...
							<div class="col-sm-12 col-lg-4 col-md-6">
								...
								<div class="product-item bg-light">
									...
									<div class="card">
										...
										<div class="card-body">
											<h4 class="card-title"><a href="single.html"><c:out value="${photocg.portfolio_title}"/></a></h4>
											<ul class="list-inline product-meta">
												<li class="list-inline-item">
													<a href="single.html"><i class="fa fa-folder-open-o"></i><c:out value="${photocg.portfolio_sCat}"/></a>
												</li>
												<li class="list-inline-item">
													<a href="#"><i class="fa fa-calendar"></i><c:out value="${photocg.portfolio_term}"/></a>
												</li>
											</ul>
											<p class="card-text"><c:out value="${photocg.portfolio_content}"/></p>
											<div class="product-ratings">
												<ul class="list-inline">
													<li class="list-inline-item selected"><i class="fa fa-star"></i><c:out value="${photocg.portfolio_rating}" /></li>
												</ul>
											</div>
										</div>
									</div>
							...
							<!-- 이전 -->
								<li class="page-item">
								 <c:choose>
									...
									<a class="page-link" href="photoCategory.do${pageMaker.makeSearch(pageMaker.startPage-1)}" aria-label="Previous">
								 ...
								 <c:forEach var="idx" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                   					<li class="page-item"> <a class="page-link"href="photoCategory.do${pageMaker.makeSearch(idx)}"> ${idx} </a> </li>
								...
								<li class="page-item">
								 <c:choose>
                        				...
                        				<a class="page-link" href="photoCategory.do${pageMaker.makeSearch(pageMaker.endPage+1)}" aria-label="Next">
