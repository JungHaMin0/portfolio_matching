									...
									<div class="card">
										<div class="thumb-content">
											...
											<a href="portfolio_detail.do">
												<img class="card-img-top img-fluid" src="data:image/jpeg;base64,<c:out value='${appcg.portfolio_Img }'/>">
											</a>
										</div>
										<div class="card-body">
							...
							<!-- 이전 -->
								<li class="page-item">
								 <c:choose>
									...
									<a class="page-link" href="appCategory.do${pageMaker.makeSearch(pageMaker.startPage-1)}" aria-label="Previous">
								 ...
								 <c:forEach var="idx" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                   					<li class="page-item"> <a class="page-link"href="appCategory.do${pageMaker.makeSearch(idx)}"> ${idx} </a> </li>
								...
								<li class="page-item">
								 <c:choose>
                        				...
                        				<a class="page-link" href="appCategory.do${pageMaker.makeSearch(pageMaker.endPage+1)}" aria-label="Next">
