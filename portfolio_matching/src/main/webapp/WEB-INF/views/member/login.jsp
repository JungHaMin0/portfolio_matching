      ...
      <div class="col-lg-4 col-md-7">
        ...
        <div class="block-2 app-promotion">
          ...
          <div class="download-btn d-flex my-3">
            <a href="#"><img src="./resources/images/apps/google-play-store.png" class="img-fluid" alt=""></a>
            <a href="#" class=" ml-3"><img src="./resources/images/apps/apple-app-store.png" class="img-fluid" alt=""></a>
          </div>
        </div>
      </div>
    </div>
