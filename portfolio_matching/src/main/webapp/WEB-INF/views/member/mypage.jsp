      ...
      <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <hr /><strong>구매 관리</strong><hr />
            <ul>
              <li class="active"><a href="dashboard-my-ads.html"><i class="fa fa-bookmark-o"></i> 관심 상품</a></li>
              <li><a href="dashboard-favourite-ads.html"><i class="fa fa-list-alt"></i> 결제 내역<span>5</span></a></li>
              <li><a href="dashboard-archived-ads.html"><i class="fa fa-thumbs-o-up"></i> 서비스 평가<span>12</span></a></li>
              <li><a href="dashboard-pending-ads.html"><i class="fa fa-bolt"></i> 문의 내역<span>23</span></a></li>
            </ul>
            
            <hr /><strong>판매 관리</strong><hr />
            <ul>
              <li><a href="dashboard-my-ads.html"><i class="fa fa-user"></i> 판매 중</a></li>
              <li><a href="dashboard-favourite-ads.html"><i class="fa fa-bookmark-o"></i> 판매 완료<span>5</span></a></li>
              <li><a href="dashboard-archived-ads.html"><i class="fa fa-file-archive-o"></i> 문의 내역<span>12</span></a></li>
              <li><a href="dashboard-pending-ads.html"><i class="fa fa-krw"></i> 수익 현황<span>23</span></a></li>
            </ul>
            
            <hr /><strong>내 정보 관리</strong><hr />
            <ul>
              <li><a href="dashboard-my-ads.html"><i class="fa fa-user"></i> 회원정보수정</a></li>
              <li><a href="dashboard-favourite-ads.html"><i class="fa fa-bookmark-o"></i> 회원탈퇴<span>5</span></a></li>
            </ul>
          </div>
